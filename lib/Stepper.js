...
function Stepper(_ref) {
  var activeStep = _ref.activeStep,
      ...
      size = _ref.size,
      delimiterClass = _ref.delimiterClass,
      stepClass = _ref.stepClass,
      titleClass = _ref.titleClass,
      circleClass = _ref.circleClass,
      ...
      stepContentClass = _ref.stepContentClass,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      steps.map(function (step, index) {
        return _react2.default.createElement(_react2.default.Fragment, {},_react2.default.createElement(_Step2.default, {
          key: index,
        ...
        }), index !== steps.length - 1 && _react2.default.createElement('div', {className: delimiterClass, style: {borderStyle: barStyle, borderColor: !(disabledSteps || []).includes(index) && index < activeStep ? completeBarColor : defaultBarColor}}));
      }),
    )
  );
}
