    ...
    _react2.default.createElement(
      ...
      steps.map(function (step, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement('div', { className: delimiterClass, style: { borderStyle: barStyle, borderColor: !(disabledSteps || []).includes(index) && index < activeStep ? completeBarColor : defaultBarColor } })
        );
      })
    )
  );
