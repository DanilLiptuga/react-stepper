  ...
  _createClass(Step, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          stepClass = _props2.stepClass,
          stepContentClass = _props2.stepContentClass,
      ...
      return _react2.default.createElement(
        'div',
        { style: styles.step, className: stepClass},_react2.default.createElement(
              'div',
              { className: stepContentClass},
        _react2.default.createElement(
          'div',
          { onClick: onClick, style: circleStyle, className: circleClass },
          active || completed ? _react2.default.createElement(
            'a',
            { href: href, onClick: onClick, style: styles.index, className: circleClass },
            stepContent
          ) : _react2.default.createElement(
            'span',
            { style: styles.index, className: circleClass },
            stepContent
          )
        ),
        active || completed ? _react2.default.createElement(
          'a',
          { href: href, onClick: onClick, style: titleStyle, className: titleClass },
          title
        ) : _react2.default.createElement(
          'div',
          { style: titleStyle, className: titleClass },
          title
        ),
